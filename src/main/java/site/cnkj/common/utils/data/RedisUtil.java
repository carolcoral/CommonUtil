...
public class RedisUtil {
    ...
    public RedisUtil(RedisTemplate<String, Object> redisTemplate, String redisName) {
        ...
        this.redisName = StringUtils.isNotEmpty(redisName)?redisName:null;
    }
     ...
     * @param count 步长，每次查询的数量大小，该值应当与实际数据基本匹配效率最大
     * @param pattern 匹配规则
     * @return keys
     */
    public HashSet<String> scan(Long count, String pattern){
